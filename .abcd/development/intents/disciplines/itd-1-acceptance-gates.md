...
- **Verdict-rollup logic** — lives in [`brief/04-surfaces/05-intent.md § 7`](../../brief/04-surfaces/05-intent.md#7-the-intent-auditor-agent-three-roles-three-verbs) (SSOT). Don't duplicate here.
