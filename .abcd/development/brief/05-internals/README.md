...
| 10 | [`10-site.md`](10-site.md) | The website as a rendered surface of the record (adr-47/adr-48): `abcd site build` and the `record.json` export, the single-source rule, the README migration, the generic/specific boundary (itd-140). The `check` gates, the explorer pages and the deploy workflow are **design targets** marked on the page. |
