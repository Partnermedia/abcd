...
| 10 | [`10-site.md`](10-site.md) | The website as a rendered surface of the record (**design target, not yet shipped** — adr-47/adr-48): the `site` verb family, the single-source rule, the README migration, the generic/specific boundary (itd-140) |
