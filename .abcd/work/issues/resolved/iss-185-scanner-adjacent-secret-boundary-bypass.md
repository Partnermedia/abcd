...
resolution: "Fixed the scanner adjacency gap: leading-\\b-anchored patterns now also detect a second same-family token that immediately abuts a first with no separator, via a boundary-free adjacency probe right after each match."
impact: fix
---
