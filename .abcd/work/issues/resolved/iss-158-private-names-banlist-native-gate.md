...
resolution: "the banlist private layer ships machine-identifier coverage: hostnames, IPv4/IPv6, CIDR prefixes and MACs in the keyed store, pinned by the corpus tests (hook_test.go keyed corpus)"
impact: additive
---
