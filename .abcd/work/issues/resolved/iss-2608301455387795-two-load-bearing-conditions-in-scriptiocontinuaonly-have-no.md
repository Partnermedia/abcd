...
impact: internal
grounds: "pursued: we expect an untested condition to be deleted by a later reader who cannot see what holds it, and a mutation-killing test is the only record of what it holds"
resolved_by:
  intent: "itd-179"
---
