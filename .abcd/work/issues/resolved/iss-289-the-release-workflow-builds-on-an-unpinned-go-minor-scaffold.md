...
resolution: "the toolchain pin shipped via the ci-dependency-gates branch: substitutions GoVersion and release.yml hold 1.25.13 in lockstep, TestSelfScaffoldParity green"
impact: fix
---
