...
blocked_by: [iss-36]
resolution: "the shipped binary no longer writes .abcd/logbook anywhere; scanner retired_location_test.go asserts the retirement, and the memory lint destination moved"
impact: internal
---
