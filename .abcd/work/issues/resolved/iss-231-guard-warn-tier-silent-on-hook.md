...
resolution: "Hook warn tier now exits 1 (loud, non-blocking) instead of exit 0 so its stderr is no longer discarded; check verb warn path unchanged at exit 0"
impact: fix
---
