...
resolution: "the identity matchers and $HOME backstop now run over the percent-decoded copy too, so a percent-encoded home path or email is redacted before it can enter a committed record"
impact: fix
resolved_by:
  commit: "e383293e"
---
