...
impact: fix
grounds: "pursued: we expect a floor answerable by characters that say nothing to be answered that way, because a caller who cannot meet it reaches for whatever the count accepts"
resolved_by:
  intent: "itd-179"
---
