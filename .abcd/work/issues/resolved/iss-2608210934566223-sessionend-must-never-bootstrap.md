...
resolution: "SessionEnd no longer bootstraps: the hook execs the plugin-root binary, falls back to an abcd on PATH, and otherwise gives up loudly. TestSessionEndNeverBootstraps pins it. Verified in the field 2026-08-23 — a cancelled SessionEnd on a machine with the plugin-root binary present never entered the bootstrap branch; the remaining cancellation there is abcd's own redaction cost, filed separately as iss-2608230817034768."
impact: fix
resolved_by:
  commit: "baf0551"
---
