...
resolution: "the per-repo pii.json read goes through fsutil.ReadGuarded: O_NOFOLLOW, a size cap and a regular-file check, with a symlinked .abcd ancestor refused before the leaf is opened. The scanner still fails closed and now names which of the four refusals it hit."
impact: fix
resolved_by:
  commit: "93f3bf28a1764420b1a724348807d05ea54ecbf7"
---
