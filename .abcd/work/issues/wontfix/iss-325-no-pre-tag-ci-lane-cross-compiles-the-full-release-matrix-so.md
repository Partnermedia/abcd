...
wontfix_reason: "adversarial review refuted materiality: the degradation is trusted-worktree-only and self-diagnosing; keeping it as a finding implies a fix that was declined"
---
