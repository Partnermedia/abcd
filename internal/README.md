...
- **`core/banlist/`** — the two banned-names stores (itd-74, spc-20). The public
  ...
  Scaffolding is NOT here either: `core/ahoy` writes the three artefacts (the
  committed guard hook, the public family, the gitignored stub) into a repo it
  configures, importing this package for the paths and for the one canonical
  statement of the private layer's reach.
